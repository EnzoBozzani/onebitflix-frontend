                    ...
                    <Col md className='d-flex flex-column justify-content-center align-items-start'>
                        ...
                        <Link href={'/register'} className={styles.linkCta}>
                            <Button outline className={styles.btnCta}>
                                ACESSE AGORA <img src='/buttonPlay.svg' alt='button image' className={styles.btnImg}/>
                            </Button>
                        </Link>
                    </Col>
                    <Col md>
                        <img src='/homeNoAuth/imgPresentation.png' alt='img presentation' className={styles.imgPresentation}/>
                    </Col>
                </Row>
                <Row>
